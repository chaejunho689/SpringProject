				...
				<form name="userUpdateForm" id="userUpdateForm">
					...
					<tr align="center">
				        <td colspan="2" height="20">
				            ...
				            <button type="button" id="deleteBtn2" onclick="location.href='/spring/user/deleteForm?id=${userDTO.id}&pg=${pg}'">회원탈퇴</button>
...
<!-- <script type="text/javascript" src="/spring/js/delete.js"></script> -->
</body>
</html>